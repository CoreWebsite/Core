   ...
   <div class="modal" id="id01">
      ...
      <form action="/action_page.php" class="modal-content animate">
         <div class="container">
            ...
            "" type="password"> <label><b>Repeat Password</b></label> <input name="psw-repeat" placeholder="Repeat Password" required="" type="password"> <input checked="checked" type="checkbox">
            Remember me
